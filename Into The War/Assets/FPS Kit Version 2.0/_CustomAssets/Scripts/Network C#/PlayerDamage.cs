			...
			if(!photonView.isMine){
				...
				if(PhotonNetwork.player == player){
					...
					if((string)PhotonNetwork.player.customProperties["TeamName"] == rmm.team_1.teamName){
						...
						teamScore ++;
                        ExitGames.Client.Photon.Hashtable setTeam1Score = new ExitGames.Client.Photon.Hashtable() { { "Team1Score", teamScore } };
					...
					if((string)PhotonNetwork.player.customProperties["TeamName"] == rmm.team_2.teamName){
						...
						teamScore ++;
                        ExitGames.Client.Photon.Hashtable setTeam2Score = new ExitGames.Client.Photon.Hashtable() { { "Team2Score", teamScore } };
